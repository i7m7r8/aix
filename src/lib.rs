...
let max_id = tasks.iter().map(|t: let max_id = tasks.iter().map(|t:         let max_id = tasks.iter().map(|t: let max_id = tasks.iter().map(|t: let max_id = tasks.iter().map(|t| t.id).max().unwrap_or(0) + 1;Task| t.id).max().unwrap_or(0) + 1;Task| t.id).max().unwrap_or(0) + 1;Task| t.id).max().unwrap_or(0) + 1;Task| t.id).max().unwrap_or(0) + 1;
